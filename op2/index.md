...
# We all care 
![](DraggedImage.png)
Most people look at the world and see things they really would like to change. We care about how our society is organised, we care about the well-being of our friends and family and we care about future of the planet at large. When we see things that threaten the things we care about we want to do something about it.  

Most people are willing to make trade-offs and sacrifices to protect the things they care about. Many are willing to give generously their time and energy to develop strategies, to share their insights and beliefs, inform and educate others. 

This is not confined to a small number of idealists. Given a realistic chance of having an impact, we are all to some degree activists.  

# We all care, but we care differently. 
![](2-2-DraggedImage.png)
Reasonable people can, and do, disagree on which areas are the most important to focus on from a sustainability standpoint.  In many of these areas, reasonable people can, and do, disagree about how to best meet the challenges. 

For example, even those who agree that Energy is a critical area might have diametrically opposed ideas on which energy sources or conservation strategies that are the most effective. Some argue that the biggest threat is Climate Change and that our best bet to combat it is to expand the use of Nuclear Power, others argue that Nuclear waste is even more dangerous. 

Some people will not buy anything made in, for example, Myanmar (Burma) because of the Military Junta, while others feel that it is more important to help boost the economy in that impoverished country by supporting the textile industry. 

# Our dollars at work for our values 
![](purchase.png)
Affecting global change through our political institutions requires consensus. Political consensus is a very elusive thing. Even if consensus can be reached on the local or national level, affecting *global* issues requires *global* consensus — an even more elusive goal. 
...
# **earthsen.se**
![](5-5-DraggedImage.png)
**earthsen.se** provides a convenient way of connecting products and services with the areas and priorities that make up our value system. We frequently have to make buying decisions quickly and need a solution that provides this information quickly and accurately at the point of sale. The **earthsen.se** mobile app gives us instant access to the collective knowledge about the product by simply scanning a barcode or a lightning-fast search of the database.  
...
Stores and Brand Owners can connect to the service using our published HTTP/JSON api. They have to opportunity to curate their business presentation and the factual information that might form the basis for their **earthsen.se** rating. They cannot influence the ratings themselves. 

Partners and Affiliates such as Eco-labels and environmental organisations can also hook into our api, allowing us to feature the certification status they have on file as a part of the product brand or company profile. 
...
**earthsen.se** models the supplier relationships between the participants in the ecosystem forming a graph connecting the sourcing of raw materials through all the manufacturing and assembly activities all the way to the customer. The companies can provide and maintain information about their ecosystem neighbourhood themselves but the information will be vetted by the community. New supplier relationships can be created by members on the site along with a justification of the claim, in much the same way as ratings are added. Supplier relationship information is reinforced by upvotes and are eligible for *CredPoint* accrual. 

Sustainability information can now be aggregated to the end-product through the supply chain, and the supply chain information can be navigated by following the supplier / customer links between companies. 
...
- It provides an enormous wall of *fame*, or *shame*, as the case may be for products brands. 

Community members are working for their individual causes and the system helps them reach out to their network and maximize the impact of their involvement, using social media to 

# Specifying our EarthPrint
![](8-8-DraggedImage.png)
We care about different aspects of sustainability. **earthsen.se** allows you to specify the aspects that you care about and their relative importance. **earthsen.se** will use this information to rank search results and select the most relevant products, brands, companies and content for you. 

As a registered member you can select the rating factors you care about from the list of the defined factors. The factors you select get a total of 100 weighting points to be distributed among them. For each of the specified factors you can allocate a weighting 1 \>= X \<= 100 indicating the relative importance of the factor. The system will make sure that the average weighting across all selected aspects will always be 50. When you increase the importance of an aspect, the importance of all the other weightings will be decreased. Consequently, as you increase the importance of an aspect, the other aspects will be reduced such that the average remains 50. 
...
## iBeacon network
**earthsen.se** will provide an iBeacon-based solution that will allow members to get notified about specific product that fits our criteria and to guide customers directly to the department or even the shelf where it can be found. 

# Big Data. Big Opportunity
![](12-12-DraggedImage.png)
The **earthsen.se** sustainability database is a treasure trove for BigData processing en insight. It is a truly huge data set which makes it a Perfect domain for Deep Learning. In addition, a very large portion of the data is categorized and tagged which aids in the training of machine learning.

## Personalization and Recommendation Systems

In **earthsen.se** is key. The whole experience is tailored to our own preference using our EarthPrint profile. The large amounts of curated, rated and tagged data allows us to train a Deep Learning system to recognize and associate products, brands and information. This information is used extensively to bring the most relevant content to the surface for each user, and allow navigation of the dataset along these dimensions of commonality. 

### Sustainability Dashboard
Sustainability is an increasingly important factor in Brand preference. By making this information readily available to consumers as they are making their purchase decisions, **earthsen.se** will help making it one of the most important criteria, making it a priority for Companies and Brand Managers to adopt sustainable practices and to articulate and effectively communicate this strategy and follow up the results.
...
### Referrals
**earthsen.se** will negotiate referral agreements with top-tier retailers for lead sales. An adaptable architecture will be put in place to track and clear referrals against retailers with existing referral systems and APIs. In addition, **earthsen.se** will include a tracking system for retailers who lack a system of their own or who prefer to use it. 

### Affiliate system
For the long tail of retailers, **earthsen.se** will enrol in as many affiliate programs as possible, either directly or through affiliate brokers. 
...
### [2 Degrees Network](https://www.2degreesnetwork.com/community/#howtouse "2 Degrees Network")
...
We can obviously not rely on the industry or governments to provide this information in an unbiased way. We tap into official product and brand databases to seed the database with the basic data. 

Business- and brand owners will be able to provide factual information about their business, products, supply chain, sustainability strategies etc, and this information will be cleansed from spin and non-factual information by the community.   
But the heart of **earthsen.se** is a global self-regulating responsible for enhancing, expanding and curating this database.  
